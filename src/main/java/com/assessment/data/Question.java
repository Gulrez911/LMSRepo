...
//@ExcelCell(10)   
	...
	private String getHrefLevel2() {
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2?qualifier1=" + getQualifier1() + "&qualifier2="
				+ getQualifier2();
		url = url.replace("$url$", meth);
	...
	private String getHrefLevel3() {
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2And3?qualifier1=" + getQualifier1() + "&qualifier2="
				+ getQualifier2() + "&qualifier3=" + getQualifier3();
		url = url.replace("$url$", meth);
	...
	private String getHrefLevel4() {
		...
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2And3And4?qualifier1=" + getQualifier1() + "&qualifier2="
				+ getQualifier2() + "&qualifier3=" + getQualifier3() + "&qualifier4=" + getQualifier4();
		url = url.replace("$url$", meth);
	...
	private String getHrefLevel5() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2And3And4And5?qualifier1=" + getQualifier1() + "&qualifier2="
				+ getQualifier2() + "&qualifier3=" + getQualifier3() + "&qualifier4=" + getQualifier4()
				+ "&qualifier5=" + getQualifier5();
		url = url.replace("$url$", meth);
	...
	private String getTestHrefLevel3() {
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQ1And2And3?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2()
				+ "&qualifier3=" + getQualifier3();
		url = url.replace("$url$", meth);
		url = url.replace("$cat$", getQualifier3());
		return url;
	}
	...
	private String getTestHrefLevel4() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQ1And2And3And4?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2()
				+ "&qualifier3=" + getQualifier3() + "&qualifier4=" + getQualifier4();
		url = url.replace("$url$", meth);
		url = url.replace("$cat$", getQualifier4());
		return url;
	}
	...
	private String getTestHrefLevel5() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQ1And2And3And4And5?qualifier1=" + getQualifier1() + "&qualifier2="
				+ getQualifier2() + "&qualifier3=" + getQualifier3() + "&qualifier4=" + getQualifier4()
				+ "&qualifier5=" + getQualifier5();
		url = url.replace("$url$", meth);
		url = url.replace("$cat$", getQualifier5());
