...
<body>
				...
				<div class="modal-body">
					<form method="GET" action="duplicateTest">
						<label>Existing test name</label> <input id="existing_name"
							...
							id="newTest" type="text" required /> <label>Qualifier 1</label>
						<input id="newQual1" type="text" required /> <label>Qualifier
	...
	$("#filetest").click();
		  ...
		  $(document).ready(function() {
			...
			var fileU = document.getElementById('filetest');
			fileU.addEventListener("change", function () {
				...
				$.ajax({
				   ...
				   url: 'uploadTest',
				    type: "POST",
				    data: new FormData(document.getElementById("fileFormTest")),
				    enctype: 'multipart/form-data',
				    processData: false,
				    contentType: false
				  }).done(function(data) {
